...
class DashboardController
{
	...
	function getByRangeDate()
	{
		...
		// echo ($to_date);
		// echo ($from_date);
		$conds = "ModifiedTime BETWEEN '$from_date' AND '$to_date'";
	...
	function getAll()
	{
		...
		if ($_GET["from_date"] && $_GET["to_date"]) {
			$cond = "ModifiedTime BETWEEN '$from_date' AND '$to_date'";
			$conds[] = $cond;
		}
		//SELECT * ... WHERE ThoiGianBD BETWEEN $start AND $end
		...
		$cond = "CustomerName LIKE '%$search%' || Phone LIKE '%$search%'";
		$conds[] = $cond;
