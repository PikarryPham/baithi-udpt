                ...
                <form action="/admin/?c=dashboard&a=update" method="POST" id="order-detail-form">
                    ...
                    <div class="left-content">
                        <div class="form-control">
                            ...
                            <input type="text" value="<?= $order->TenKH ?>" name="TenKH" readonly>
                            <small></small>
                        </div>

                        <div class="form-control">
                            <label for="">Phone Number</label>
                            <input type="text" value="<?= $order->DienThoai ?>" name="DienThoai" readonly>
                            <small></small>
                        </div>

                        <div class="form-control">
                            <label for="">Address</label>
                            <input type="text" value="<?= $order->DiaChi ?>" name="DiaChi" readonly>
                            <small></small>
                        </div>

                        <div class="form-control">
                            <label for="">Order time</label>
                            <input type="text" value="<?= $order->ThoiGianBD ?>" name="ThoiGianBD" readonly>
                            <small></small>
                        </div>
                    ...
                    <div class="right-content">
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" value="<?= $order->SoLuong ?>" readonly>
                            <small></small>
                        </div>
